...
protected:
    void SetUp() override
    {
        ...
        ASSERT_TRUE(ffsp::ffsp_testing::default_mkfs_ffsp());
        ASSERT_TRUE(ffsp::ffsp_testing::default_mount_ffsp());
    }

    void TearDown() override
    {
        ASSERT_TRUE(ffsp::ffsp_testing::default_unmount_ffsp());
...
//    ASSERT_TRUE(std::system(command.c_str()) == 0);
    ...
    command = std::string("cp /etc/lsb-release ") + ffsp::ffsp_testing::default_dir_mountpoint;
    ASSERT_TRUE(std::system(command.c_str()) == 0);
